...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    public class WireRodTypesController : ControllerBase
    {
        IFreeSql _fsql;
        private readonly IMapper _mapper;

        public WireRodTypesController(IFreeSql fsql, IMapper mapper)
        {
            _fsql = fsql;
            _mapper = mapper;
        }
        ...
        async public Task<IResponseOutput> Create([FromBody] WireRodTypeCreateRequestDto requestDto)
        {
            ...
            var ret = await _fsql.Insert(_mapper.Map<WireRodType>(requestDto)).ExecuteInsertedAsync();
